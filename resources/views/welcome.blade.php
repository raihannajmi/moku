          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="today-home-tab">

                <!-- total orders -->

                <div class="row" style="display: flex;">
                    <div class="card info-card orders-card" style="flex: 0 0 33%;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">Total Orders <br><strong>jumlah order</strong></h3>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="ps-2 text-start">
                                        <p class="mb-0" style="margin-bottom: 5px;">success<span> | 50</span></p>
                                        <span style="margin-top: 5px;">active <span> | 4 </span></span>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="ps-1 text-start">
                                        <p class="mb-0" style="margin-bottom: 5px;">Ready<span> | 60</span></p>
                                        <span style="margin-top: 10px;">off <span> | 4 </span></span>
                    ...
                    <div class="card info-card orders-card" style="flex: 0 0 33%;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">pelanggan <br><strong>jumlah pelanggan</strong></h3>
                                
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="ps-1 text-start">
                                        <p class="mb-0" style="margin-bottom: 10px;">success<span> | 60</span></p>
                                        <span style="margin-top: 10px;">active <span> | 4 </span></span>
                    ...
                    <div class="card info-card orders-card" style="flex: 0 0 33%;">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="card-title mb-0">Total  <br><strong>jumlah uang</strong></h3>
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- <div class="ps-1 text-start">
                                        <p class="mb-0" style="margin-bottom: 10px;">success<span> | 60</span></p>
                                        <span style="margin-top: 10px;">active <span> | 4 </span></span> -->
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="this-week-tab">
                ...
                <div class="tab-pane fade" id="bordered-contact" role="tabpanel" aria-labelledby="last-year tab">
